...
![Dolphin 无法连接](../../assets/images/Pasted%20image%2020260720023107.png)
...
1. 这是一种临时解决方式，可以在地址栏输入 `smb://用户名:密码@服务器/` 即可访问
   ![地址栏输入](../../assets/images/Pasted%20image%2020260720023858.png)
...
2. 这种方法更彻底，适合在主力机里使用
   ...
   ```
   ![fstab 编辑](../../assets/images/Pasted%20image%2020260720024418.png)

   将配置文件中的路径改成你的实际路径，重启电脑即可  
   下次重启后，会自动挂载到 `/mnt/笔记`（或者你自己设定的目录）  
   此时在地址栏访问 `/mnt/笔记` 即可。同时也可以固定到侧边栏
   ![访问成功](../../assets/images/Pasted%20image%2020260720024625.png)
